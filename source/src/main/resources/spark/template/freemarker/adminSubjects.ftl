...
<@layout.template title="${lang.categorias}">
    ...
    <div class="w3-row w3-padding-8">
        ...
        <a href="/subjects">
            <div class="w3-half w3-bottombar w3-hover-light-grey w3-padding w3-border-red"><i class="fa fa-tags"></i> ${lang.categorias}</div>
        </a>
    </div>
    <div id="Usuarios" class="w3-container tab">
        <#include "*/snipets/admin/subjects.ftl">
    </div>
</@layout.template>